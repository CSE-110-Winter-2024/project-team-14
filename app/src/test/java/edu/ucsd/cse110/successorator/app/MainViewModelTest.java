...
public class MainViewModelTest {
    ...
    public void appendTest() {
        ...
        Goal g = new Goal(null, "do homework", false, 4, "school", LocalDateTime.now(), "one_time", false);
        mvm.append(g);
    ...
    public void getOrderedGoalsTest() {
        ...
        mvm.append(new Goal(null, "do homework", false, 4,"school", LocalDateTime.now(), "one_time", false));
    ...
    public void removeTest() {
        ...
        Goal g1 = new Goal(null, "do homework", false, 0, "school", LocalDateTime.now(), "one_time", false);
        mvm.append(g1);
        mvm.append(new Goal(null, "wash dishes", false, 1, "school", LocalDateTime.now(), "one_time", false));
        mvm.remove(1);
        var orderedGoals = mvm.getOrderedGoals();
    ...
    public void updateGoalTest() {
        ...
        Goal g = new Goal(null, "do homework", false, 1, "school", LocalDateTime.now(), "one_time", false);
        mvm.append(g);
    ...
    public void listPersistence3TaskRolloverTest() {
        ...
        Goal g2 = new Goal(null, "do homework2", false, 2, "school", LocalDateTime.now(),"one_time",  false);
        mainViewModel.append(g2);
        Goal g3 = new Goal(null, "do homework3", false, 3, "school", LocalDateTime.now(), "one_time", false);
    ...
    public void listPersistence2TaskRollover1CompleteTest() {
        ...
        Goal g2 = new Goal(null, "do homework2", false, 2, "school", LocalDateTime.now(), "one_time", false);
        mainViewModel.append(g2);
        Goal g3 = new Goal(null, "do homework3", true, 3, "school", LocalDateTime.now(), "one_time", false);
        mainViewModel.append(g3);
    ...
    public void listPersistenceAllTasksCompleteTest() {
        ...
        Goal g = new Goal(null, "do homework", true, 1, "school", LocalDateTime.now(),"one_time",  false);
        mainViewModel.append(g);
        Goal g2 = new Goal(null, "do homework2", true, 2, "school", LocalDateTime.now(), "one_time", false);
        mainViewModel.append(g2);
        Goal g3 = new Goal(null, "do homework3", true, 3, "school", LocalDateTime.now(), "one_time", false);
        mainViewModel.append(g3);
    ...
    public void filterContextTest() {
        ...
        Goal g2 = new Goal(null, "wash laundry", false, 0,
                "Work", LocalDateTime.now(), "one_time", false);
        mvm.append(g2);

        // add a goal with "Home" context
        Goal g3 = new Goal(0, "do homework", false, 0,
                "Home", LocalDateTime.now(), "one_time", false);
        mvm.append(g3);
    ...
    public void pendingPersistenceTest() {
        ...
        TimeKeeper timeKeeper = new InMemoryTimeKeeper();
        var mainViewModel = new MainViewModel(repo, timeKeeper);
        Goal g = new Goal(null, "do homework", true, 1, "school", LocalDateTime.now(), "one_time", true);
        mainViewModel.append(g);
        Goal g2 = new Goal(null, "do homework2", true, 2, "school", LocalDateTime.now(),"one_time",  true);
        mainViewModel.append(g2);
        Goal g3 = new Goal(null, "do homework3", true, 3, "school", LocalDateTime.now(),"one_time",  false);
        mainViewModel.append(g3);
    ...
    public void recurrenceTest() {
        ...
        Goal g2 = new Goal(null, "do homework2", true, 2, "School", LocalDateTime.now(), "weekly", false);
        mvm.append(g2);
        List<Goal> orderedGoals = mvm.getOrderedGoals().getValue();

        assertEquals(2, orderedGoals.size());

        // Get the current date and time
        LocalDateTime currentDateTime = mvm.getCurrentDateTime().getValue();
        // Add one day to get to the next day
        LocalDateTime nextDayDateTime = currentDateTime.plusDays(7);
        // Set the time to 2 AM
        LocalDateTime nextDay2AM = nextDayDateTime.withHour(2).withMinute(0);
        // Set the updated date and time in the mainViewModel
        mvm.setCurrentDateTime(nextDay2AM);

        List<Goal> orderedGoals2 = mvm.getOrderedGoals().getValue();
        assertEquals(1, orderedGoals2.size());
    }
}