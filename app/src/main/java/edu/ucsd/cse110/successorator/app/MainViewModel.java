...
public class MainViewModel extends ViewModel {
    ...
    private final MutableSubject<List<Goal>> tomorrowOrderedGoals;
    ...
    public MainViewModel(GoalRepository goalRepository, TimeKeeper timeKeeper) {
        ...
        this.tomorrowOrderedGoals = new SimpleSubject<>();
        ...
        goalRepository.findAllTomorrowGoals().observe(goals -> {
            if (goals == null) return; // not ready yet, ignore
            var newOrderedGoals = goals.stream()
                    .sorted(Comparator.comparingInt(Goal::sortOrder))
                    .collect(Collectors.toList());
            tomorrowOrderedGoals.setValue(newOrderedGoals);
        });
    ...
    public Subject<List<Goal>> getTomorrowOrderedGoals() {
        return tomorrowOrderedGoals;
    }
